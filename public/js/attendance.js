$(document).ready(function() {
    ...
    setInterval(() => {
        ...
        data = data + `<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous"></thead>`;
        data = data +  `<tr class="table-primary">
                    <th>#</th>
                    <th>Nama</th>
                    <th>Kelas</th>
                    <th>Foto</th>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(response, function(index, value) {
                    ...
                    if (value.desc === 'masuk') {
                        color = 'text-primary'
                    } else if (value.desc === 'sakit' || value.desc === 'ijin') {
                        color = 'text-warning'
                    }
                        ...
                        <td>
                            <div class='profile-pic-box rounded-circle'>
                                <a href="` + value.photo + `" target="_blank">
                                    <img src="` + value.photo + `" alt="Profile" class="img-fluid">
                                </a>
                            </div>
                        </td>
                        <td class='` + color + `'>` + value.desc + `</td>
